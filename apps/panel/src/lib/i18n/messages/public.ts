...
const en = {
  ...
  planFeaturesHeading: "What's included",
  planCurrent: "Current plan",
  planActive: "Active subscription",
  planSubscribe: "Subscribe",
  planCadenceMonthly: "Billed monthly",
  planCadenceYearly: "Billed yearly",
  planCadenceOnce: "One-time payment",
  planCadenceFree: "Free forever",
  planStorage: "{value} storage",
  planStorageUnlimited: "Unlimited storage",
  planRam: "{value} RAM",
  planRamUnlimited: "Unlimited RAM",
  planCpuCoresOne: "{count} vCPU core",
  planCpuCoresOther: "{count} vCPU cores",
  planCpuPercent: "{value}% CPU",
  planCpuUnlimited: "Unlimited CPU",
  planDatabasesOne: "{count} database",
  planDatabasesOther: "{count} databases",
  planPortsOne: "{count} network port",
  planPortsOther: "{count} network ports",
  planBackupsOne: "{count} backup",
  planBackupsOther: "{count} backups",
...
const ar: Record<keyof typeof en, string> = {
  ...
  // pricing page — plan cards
  planFeaturesHeading: "ما الذي تحصل عليه",
  planCurrent: "خطتك الحالية",
  planActive: "اشتراك نشط",
  planSubscribe: "اشترك الآن",
  planCadenceMonthly: "يُدفع شهرياً",
  planCadenceYearly: "يُدفع سنوياً",
  planCadenceOnce: "دفعة لمرة واحدة",
  planCadenceFree: "مجاني للأبد",
  planStorage: "مساحة تخزين {value}",
  planStorageUnlimited: "مساحة تخزين غير محدودة",
  planRam: "ذاكرة عشوائية {value}",
  planRamUnlimited: "ذاكرة عشوائية غير محدودة",
  planCpuCoresOne: "نواة معالجة افتراضية واحدة",
  planCpuCoresOther: "{count} نواة معالجة افتراضية",
  planCpuPercent: "{value}% من المعالج",
  planCpuUnlimited: "معالج غير محدود",
  planDatabasesOne: "قاعدة بيانات واحدة",
  planDatabasesOther: "{count} قاعدة بيانات",
  planPortsOne: "منفذ شبكة واحد",
  planPortsOther: "{count} منافذ شبكة",
  planBackupsOne: "نسخة احتياطية واحدة",
  planBackupsOther: "{count} نسخ احتياطية",
